   ...
   <div>
    <div class="">
        <div class="relative z-10">
            <div class='fixed w-full'>
                <div class="flex items-center justify-between bg-purple-900 py-1 h-20">
                    ...
                    <div class='w-4/12'>
                        <div class="flex m-4">
                            <div class="w-2/6 m-2 " alt="" srcset="">
                                <div class='w-16 m-auto'>
                                    <?php echo '<img src="data:image/jpeg;base64,'.base64_encode($row['photo_profile']).'"/>';?>
                                </div>
                            </div>
                            <div class='w-3/6 m-auto h-center font-bold text-2xl text-white ml-12'>
        ...
        <?php while ($row = mysqli_fetch_assoc($resultt)): ?>
            <div class='bg-primary px-10 py-5 space-y-10 pt-32'>
                <div>
